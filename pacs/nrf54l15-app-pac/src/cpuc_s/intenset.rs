...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fpuioc(&mut self) -> FpuiocW<IntensetSpec> {
        FpuiocW::new(self, 0)
    }
    #[doc = "Bit 1 - Write '1' to enable interrupt for event FPUDZC"]
    #[inline(always)]
    #[must_use]
    pub fn fpudzc(&mut self) -> FpudzcW<IntensetSpec> {
        FpudzcW::new(self, 1)
    }
    #[doc = "Bit 2 - Write '1' to enable interrupt for event FPUOFC"]
    #[inline(always)]
    #[must_use]
    pub fn fpuofc(&mut self) -> FpuofcW<IntensetSpec> {
        FpuofcW::new(self, 2)
    }
    #[doc = "Bit 3 - Write '1' to enable interrupt for event FPUUFC"]
    #[inline(always)]
    #[must_use]
    pub fn fpuufc(&mut self) -> FpuufcW<IntensetSpec> {
        FpuufcW::new(self, 3)
    }
    #[doc = "Bit 4 - Write '1' to enable interrupt for event FPUIXC"]
    #[inline(always)]
    #[must_use]
    pub fn fpuixc(&mut self) -> FpuixcW<IntensetSpec> {
        FpuixcW::new(self, 4)
    }
    #[doc = "Bit 5 - Write '1' to enable interrupt for event FPUIDC"]
    #[inline(always)]
    #[must_use]
    pub fn fpuidc(&mut self) -> FpuidcW<IntensetSpec> {
        FpuidcW::new(self, 5)
    }
}
