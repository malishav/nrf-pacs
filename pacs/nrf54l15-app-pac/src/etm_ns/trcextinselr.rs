...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sel_0(&mut self) -> Sel0W<TrcextinselrSpec> {
        Sel0W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Each field in this collection selects an external input as a resource for the trace unit."]
    #[inline(always)]
    #[must_use]
    pub fn sel_1(&mut self) -> Sel1W<TrcextinselrSpec> {
        Sel1W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Each field in this collection selects an external input as a resource for the trace unit."]
    #[inline(always)]
    #[must_use]
    pub fn sel_2(&mut self) -> Sel2W<TrcextinselrSpec> {
        Sel2W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Each field in this collection selects an external input as a resource for the trace unit."]
    #[inline(always)]
    #[must_use]
    pub fn sel_3(&mut self) -> Sel3W<TrcextinselrSpec> {
        Sel3W::new(self, 24)
    }
}
