...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn set_0(&mut self) -> Set0W<TrcclaimsetSpec> {
        Set0W::new(self, 0)
    }
    #[doc = "Bit 1 - Claim tag set register"]
    #[inline(always)]
    #[must_use]
    pub fn set_1(&mut self) -> Set1W<TrcclaimsetSpec> {
        Set1W::new(self, 1)
    }
    #[doc = "Bit 2 - Claim tag set register"]
    #[inline(always)]
    #[must_use]
    pub fn set_2(&mut self) -> Set2W<TrcclaimsetSpec> {
        Set2W::new(self, 2)
    }
    #[doc = "Bit 3 - Claim tag set register"]
    #[inline(always)]
    #[must_use]
    pub fn set_3(&mut self) -> Set3W<TrcclaimsetSpec> {
        Set3W::new(self, 3)
    }
}
