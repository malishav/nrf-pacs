...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn insten_0(&mut self) -> Insten0W<Trceventctl1rSpec> {
        Insten0W::new(self, 0)
    }
    #[doc = "Bit 1 - Instruction event enable field."]
    #[inline(always)]
    #[must_use]
    pub fn insten_1(&mut self) -> Insten1W<Trceventctl1rSpec> {
        Insten1W::new(self, 1)
    }
    #[doc = "Bit 2 - Instruction event enable field."]
    #[inline(always)]
    #[must_use]
    pub fn insten_2(&mut self) -> Insten2W<Trceventctl1rSpec> {
        Insten2W::new(self, 2)
    }
    #[doc = "Bit 3 - Instruction event enable field."]
    #[inline(always)]
    #[must_use]
    pub fn insten_3(&mut self) -> Insten3W<Trceventctl1rSpec> {
        Insten3W::new(self, 3)
    }
    #[doc = "Bit 4 - Data event enable bit."]
    #[inline(always)]
    #[must_use]
    pub fn dataen(&mut self) -> DataenW<Trceventctl1rSpec> {
        DataenW::new(self, 4)
    }
    #[doc = "Bit 11 - AMBA Trace Bus (ATB) trigger enable bit."]
    #[inline(always)]
    #[must_use]
    pub fn atb(&mut self) -> AtbW<Trceventctl1rSpec> {
        AtbW::new(self, 11)
    }
    #[doc = "Bit 12 - Low-power state behavior override bit. Controls how a trace unit behaves in low-power state."]
    #[inline(always)]
    #[must_use]
    pub fn lpoverride(&mut self) -> LpoverrideW<Trceventctl1rSpec> {
