...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn inst(&mut self) -> InstW<Trcsscsr0Spec> {
        InstW::new(self, 0)
    }
    #[doc = "Bit 1 - Data address comparator support"]
    #[inline(always)]
    #[must_use]
    pub fn da(&mut self) -> DaW<Trcsscsr0Spec> {
        DaW::new(self, 1)
    }
    #[doc = "Bit 2 - Data value comparator support"]
    #[inline(always)]
    #[must_use]
    pub fn dv(&mut self) -> DvW<Trcsscsr0Spec> {
        DvW::new(self, 2)
    }
    #[doc = "Bit 3 - Process counter value comparator support"]
    #[inline(always)]
    #[must_use]
    pub fn pc(&mut self) -> PcW<Trcsscsr0Spec> {
        PcW::new(self, 3)
    }
    #[doc = "Bit 31 - Single-shot status. This indicates whether any of the selected comparators have matched."]
    #[inline(always)]
    #[must_use]
    pub fn status(&mut self) -> StatusW<Trcsscsr0Spec> {
        StatusW::new(self, 31)
    }
}
