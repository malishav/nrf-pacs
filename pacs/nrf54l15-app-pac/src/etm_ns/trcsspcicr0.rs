...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc_0(&mut self) -> Pc0W<Trcsspcicr0Spec> {
        Pc0W::new(self, 0)
    }
    #[doc = "Bit 1 - Selects processor comparator 1 inputs for Single-shot control"]
    #[inline(always)]
    #[must_use]
    pub fn pc_1(&mut self) -> Pc1W<Trcsspcicr0Spec> {
        Pc1W::new(self, 1)
    }
    #[doc = "Bit 2 - Selects processor comparator 2 inputs for Single-shot control"]
    #[inline(always)]
    #[must_use]
    pub fn pc_2(&mut self) -> Pc2W<Trcsspcicr0Spec> {
        Pc2W::new(self, 2)
    }
    #[doc = "Bit 3 - Selects processor comparator 3 inputs for Single-shot control"]
    #[inline(always)]
    #[must_use]
    pub fn pc_3(&mut self) -> Pc3W<Trcsspcicr0Spec> {
        Pc3W::new(self, 3)
    }
}
