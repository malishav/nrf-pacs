...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn f_0(&mut self) -> F0W<TrcseqevrSpec> {
        F0W::new(self, 0)
    }
    #[doc = "Bit 1 - Forward field."]
    #[inline(always)]
    #[must_use]
    pub fn f_1(&mut self) -> F1W<TrcseqevrSpec> {
        F1W::new(self, 1)
    }
    #[doc = "Bit 2 - Forward field."]
    #[inline(always)]
    #[must_use]
    pub fn f_2(&mut self) -> F2W<TrcseqevrSpec> {
        F2W::new(self, 2)
    }
    #[doc = "Bit 3 - Forward field."]
    #[inline(always)]
    #[must_use]
    pub fn f_3(&mut self) -> F3W<TrcseqevrSpec> {
        F3W::new(self, 3)
    }
    #[doc = "Bit 4 - Forward field."]
    #[inline(always)]
    #[must_use]
    pub fn f_4(&mut self) -> F4W<TrcseqevrSpec> {
        F4W::new(self, 4)
    }
    #[doc = "Bit 5 - Forward field."]
    #[inline(always)]
    #[must_use]
    pub fn f_5(&mut self) -> F5W<TrcseqevrSpec> {
        F5W::new(self, 5)
    }
    #[doc = "Bit 6 - Forward field."]
    #[inline(always)]
    #[must_use]
    pub fn f_6(&mut self) -> F6W<TrcseqevrSpec> {
        F6W::new(self, 6)
    }
    #[doc = "Bit 7 - Forward field."]
    #[inline(always)]
    #[must_use]
    pub fn f_7(&mut self) -> F7W<TrcseqevrSpec> {
        F7W::new(self, 7)
    }
    #[doc = "Bit 8 - Backward field."]
    #[inline(always)]
    #[must_use]
    pub fn b_0(&mut self) -> B0W<TrcseqevrSpec> {
        B0W::new(self, 8)
    }
    #[doc = "Bit 9 - Backward field."]
    #[inline(always)]
    #[must_use]
    pub fn b_1(&mut self) -> B1W<TrcseqevrSpec> {
        B1W::new(self, 9)
    }
    #[doc = "Bit 10 - Backward field."]
    #[inline(always)]
    #[must_use]
    pub fn b_2(&mut self) -> B2W<TrcseqevrSpec> {
        B2W::new(self, 10)
    }
    #[doc = "Bit 11 - Backward field."]
    #[inline(always)]
    #[must_use]
    pub fn b_3(&mut self) -> B3W<TrcseqevrSpec> {
        B3W::new(self, 11)
    }
    #[doc = "Bit 12 - Backward field."]
    #[inline(always)]
    #[must_use]
    pub fn b_4(&mut self) -> B4W<TrcseqevrSpec> {
        B4W::new(self, 12)
    }
    #[doc = "Bit 13 - Backward field."]
    #[inline(always)]
    #[must_use]
    pub fn b_5(&mut self) -> B5W<TrcseqevrSpec> {
        B5W::new(self, 13)
    }
    #[doc = "Bit 14 - Backward field."]
    #[inline(always)]
    #[must_use]
    pub fn b_6(&mut self) -> B6W<TrcseqevrSpec> {
        B6W::new(self, 14)
    }
    #[doc = "Bit 15 - Backward field."]
    #[inline(always)]
    #[must_use]
    pub fn b_7(&mut self) -> B7W<TrcseqevrSpec> {
        B7W::new(self, 15)
    }
}
...
#[doc = "`reset()` method sets TRCSEQEVR[%s]
to value 0"]
