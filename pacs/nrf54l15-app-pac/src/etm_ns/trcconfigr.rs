...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Vmidopt {
    #[doc = "0: VTTBR_EL2.VMID is used. If the trace unit supports a Virtual context identifier larger than the VTTBR_EL2.VMID, the upper unused bits are always zero. If the trace unit supports a Virtual context identifier larger than 8 bits and if the VTCR_EL2.VS bit forces use of an 8-bit Virtual context identifier, bits \\[15:8\\]
of the trace unit Virtual context identifier are always zero."]
    VttbrEl2 = 0,
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn loadasp0inst(&mut self) -> Loadasp0instW<TrcconfigrSpec> {
        Loadasp0instW::new(self, 1)
    }
    #[doc = "Bit 2 - Instruction P0 field. This field controls whether store instructions are traced as P0 instructions."]
    #[inline(always)]
    #[must_use]
    pub fn storeasp0inst(&mut self) -> Storeasp0instW<TrcconfigrSpec> {
        Storeasp0instW::new(self, 2)
    }
    #[doc = "Bit 3 - Branch broadcast mode bit."]
    #[inline(always)]
    #[must_use]
    pub fn bb(&mut self) -> BbW<TrcconfigrSpec> {
        BbW::new(self, 3)
    }
    #[doc = "Bit 4 - Cycle counting instruction trace bit."]
    #[inline(always)]
    #[must_use]
    pub fn cci(&mut self) -> CciW<TrcconfigrSpec> {
        CciW::new(self, 4)
    }
    #[doc = "Bit 6 - Context ID tracing bit."]
    #[inline(always)]
    #[must_use]
    pub fn cid(&mut self) -> CidW<TrcconfigrSpec> {
        CidW::new(self, 6)
    }
    #[doc = "Bit 7 - Virtual context identifier tracing bit."]
    #[inline(always)]
    #[must_use]
    pub fn vmid(&mut self) -> VmidW<TrcconfigrSpec> {
        VmidW::new(self, 7)
    }
    #[doc = "Bits 8:10 - Conditional instruction tracing bit."]
    #[inline(always)]
    #[must_use]
    pub fn cond(&mut self) -> CondW<TrcconfigrSpec> {
        CondW::new(self, 8)
    }
    #[doc = "Bit 11 - Global timestamp tracing bit."]
    #[inline(always)]
    #[must_use]
    pub fn ts(&mut self) -> TsW<TrcconfigrSpec> {
        TsW::new(self, 11)
    }
    #[doc = "Bit 12 - Return stack enable bit."]
    #[inline(always)]
    #[must_use]
    pub fn rs(&mut self) -> RsW<TrcconfigrSpec> {
        RsW::new(self, 12)
    }
    #[doc = "Bits 13:14 - Q element enable field."]
    #[inline(always)]
    #[must_use]
    pub fn qe(&mut self) -> QeW<TrcconfigrSpec> {
        QeW::new(self, 13)
    }
    #[doc = "Bit 15 - Control bit to select the Virtual context identifier value used by the trace unit, both for trace generation and in the Virtual context identifier comparators."]
    #[inline(always)]
    #[must_use]
    pub fn vmidopt(&mut self) -> VmidoptW<TrcconfigrSpec> {
        VmidoptW::new(self, 15)
    }
    #[doc = "Bit 16 - Data address tracing bit."]
    #[inline(always)]
    #[must_use]
    pub fn da(&mut self) -> DaW<TrcconfigrSpec> {
        DaW::new(self, 16)
    }
    #[doc = "Bit 17 - Data value tracing bit."]
    #[inline(always)]
    #[must_use]
    pub fn dv(&mut self) -> DvW<TrcconfigrSpec> {
        DvW::new(self, 17)
    }
}
