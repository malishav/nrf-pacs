...
#[doc = "Controls which information a trace unit populates in bits\\[63:56\\]
of the data address.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Tbi {
    #[doc = "0: The trace unit assigns bits\\[63:56\\]
to have the same value as bit\\[55\\]
of the data address, that is, it sign-extends the value."]
    SignExtend = 0,
    #[doc = "1: The trace unit assigns bits\\[63:56\\]
to have the same value as bits\\[63:56\\]
of the data address."]
    Copy = 1,
}
...
#[doc = "Field `TBI` reader - Controls which information a trace unit populates in bits\\[63:56\\]
of the data address."]
...
impl TbiR {
    ...
    #[doc = "The trace unit assigns bits\\[63:56\\]
to have the same value as bit\\[55\\]
of the data address, that is, it sign-extends the value."]
    #[inline(always)]
...
#[doc = "Field `TBI` writer - Controls which information a trace unit populates in bits\\[63:56\\]
of the data address."]
...
impl R {
    ...
    #[doc = "Bit 11 - Controls which information a trace unit populates in bits\\[63:56\\]
of the data address."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn event_0(&mut self) -> Event0W<TrcvdctlrSpec> {
        Event0W::new(self, 0)
    }
    #[doc = "Bit 1 - Event unit enable bit."]
    #[inline(always)]
    #[must_use]
    pub fn event_1(&mut self) -> Event1W<TrcvdctlrSpec> {
        Event1W::new(self, 1)
    }
    #[doc = "Bit 2 - Event unit enable bit."]
    #[inline(always)]
    #[must_use]
    pub fn event_2(&mut self) -> Event2W<TrcvdctlrSpec> {
        Event2W::new(self, 2)
    }
    #[doc = "Bit 3 - Event unit enable bit."]
    #[inline(always)]
    #[must_use]
    pub fn event_3(&mut self) -> Event3W<TrcvdctlrSpec> {
        Event3W::new(self, 3)
    }
    #[doc = "Bit 4 - Event unit enable bit."]
    #[inline(always)]
    #[must_use]
    pub fn event_4(&mut self) -> Event4W<TrcvdctlrSpec> {
        Event4W::new(self, 4)
    }
    #[doc = "Bit 5 - Event unit enable bit."]
    #[inline(always)]
    #[must_use]
    pub fn event_5(&mut self) -> Event5W<TrcvdctlrSpec> {
        Event5W::new(self, 5)
    }
    #[doc = "Bit 6 - Event unit enable bit."]
    #[inline(always)]
    #[must_use]
    pub fn event_6(&mut self) -> Event6W<TrcvdctlrSpec> {
        Event6W::new(self, 6)
    }
    #[doc = "Bit 7 - Event unit enable bit."]
    #[inline(always)]
    #[must_use]
    pub fn event_7(&mut self) -> Event7W<TrcvdctlrSpec> {
        Event7W::new(self, 7)
    }
    #[doc = "Bits 8:9 - Controls whether a trace unit traces data for transfers that are relative to the Stack Pointer (SP)."]
    #[inline(always)]
    #[must_use]
    pub fn sprel(&mut self) -> SprelW<TrcvdctlrSpec> {
        SprelW::new(self, 8)
    }
    #[doc = "Bit 10 - Controls whether a trace unit traces data for transfers that are relative to the Program Counter (PC)."]
    #[inline(always)]
    #[must_use]
    pub fn pcrel(&mut self) -> PcrelW<TrcvdctlrSpec> {
        PcrelW::new(self, 10)
    }
    #[doc = "Bit 11 - Controls which information a trace unit populates in bits\\[63:56\\]
of the data address."]
    #[inline(always)]
    #[must_use]
    pub fn tbi(&mut self) -> TbiW<TrcvdctlrSpec> {
        TbiW::new(self, 11)
    }
    #[doc = "Bit 12 - Controls the tracing of data transfers for exceptions and exception returns on Armv6-M, Armv7-M, and Armv8-M PEs."]
    #[inline(always)]
    #[must_use]
    pub fn trcexdata(&mut self) -> TrcexdataW<TrcvdctlrSpec> {
