...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clr_0(&mut self) -> Clr0W<TrcclaimclrSpec> {
        Clr0W::new(self, 0)
    }
    #[doc = "Bit 1 - Claim tag clear register"]
    #[inline(always)]
    #[must_use]
    pub fn clr_1(&mut self) -> Clr1W<TrcclaimclrSpec> {
        Clr1W::new(self, 1)
    }
    #[doc = "Bit 2 - Claim tag clear register"]
    #[inline(always)]
    #[must_use]
    pub fn clr_2(&mut self) -> Clr2W<TrcclaimclrSpec> {
        Clr2W::new(self, 2)
    }
    #[doc = "Bit 3 - Claim tag clear register"]
    #[inline(always)]
    #[must_use]
    pub fn clr_3(&mut self) -> Clr3W<TrcclaimclrSpec> {
        Clr3W::new(self, 3)
    }
}
