...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bit_0(&mut self) -> Bit0W<ClaimclrSpec> {
        Bit0W::new(self, 0)
    }
    #[doc = "Bit 1 - Read or clear claim bit 1."]
    #[inline(always)]
    #[must_use]
    pub fn bit_1(&mut self) -> Bit1W<ClaimclrSpec> {
        Bit1W::new(self, 1)
    }
    #[doc = "Bit 2 - Read or clear claim bit 2."]
    #[inline(always)]
    #[must_use]
    pub fn bit_2(&mut self) -> Bit2W<ClaimclrSpec> {
        Bit2W::new(self, 2)
    }
    #[doc = "Bit 3 - Read or clear claim bit 3."]
    #[inline(always)]
    #[must_use]
    pub fn bit_3(&mut self) -> Bit3W<ClaimclrSpec> {
        Bit3W::new(self, 3)
    }
}
