...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn enftc(&mut self) -> EnftcW<FfcrSpec> {
        EnftcW::new(self, 0)
    }
    #[doc = "Bit 1 - Is embedded in trigger packets and indicates that no cycle is using sync packets."]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn fonflin(&mut self) -> FonflinW<FfcrSpec> {
        FonflinW::new(self, 4)
    }
    #[doc = "Bit 5 - Initiates a manual flush of data in the system when a trigger event occurs."]
    #[inline(always)]
    #[must_use]
    pub fn fontrig(&mut self) -> FontrigW<FfcrSpec> {
        FontrigW::new(self, 5)
    }
    #[doc = "Bit 6 - Generates a flush. This bit is set to 0 when this flush is serviced."]
    #[inline(always)]
    #[must_use]
    pub fn fonmanr(&mut self) -> FonmanrW<FfcrSpec> {
        FonmanrW::new(self, 6)
    }
    #[doc = "Bit 7 - Generates a flush. This bit is set to 1 when this flush is serviced."]
    #[inline(always)]
    #[must_use]
    pub fn fonmanw(&mut self) -> FonmanwW<FfcrSpec> {
        FonmanwW::new(self, 7)
    }
    #[doc = "Bit 8 - Indicates a trigger when trigin is asserted."]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn trigevt(&mut self) -> TrigevtW<FfcrSpec> {
        TrigevtW::new(self, 9)
    }
    #[doc = "Bit 10 - Indicates a trigger when flush completion on afreadys is returned."]
    #[inline(always)]
    #[must_use]
    pub fn trigfl(&mut self) -> TrigflW<FfcrSpec> {
        TrigflW::new(self, 10)
    }
    #[doc = "Bit 12 - Forces the FIFO to drain off any part-completed packets."]
    #[inline(always)]
    #[must_use]
    pub fn stopfl(&mut self) -> StopflW<FfcrSpec> {
        StopflW::new(self, 12)
    }
    #[doc = "Bit 13 - Stops the formatter after a trigger event is observed. Reset to disabled or 0."]
    #[inline(always)]
    #[must_use]
    pub fn stoptrig(&mut self) -> StoptrigW<FfcrSpec> {
