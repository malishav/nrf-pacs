...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn extctlin_0(&mut self) -> Extctlin0W<ExtctlinportSpec> {
        Extctlin0W::new(self, 0)
    }
    #[doc = "Bit 1 - EXTCTL inputs."]
    #[inline(always)]
    #[must_use]
    pub fn extctlin_1(&mut self) -> Extctlin1W<ExtctlinportSpec> {
        Extctlin1W::new(self, 1)
    }
    #[doc = "Bit 2 - EXTCTL inputs."]
    #[inline(always)]
    #[must_use]
    pub fn extctlin_2(&mut self) -> Extctlin2W<ExtctlinportSpec> {
        Extctlin2W::new(self, 2)
    }
    #[doc = "Bit 3 - EXTCTL inputs."]
    #[inline(always)]
    #[must_use]
    pub fn extctlin_3(&mut self) -> Extctlin3W<ExtctlinportSpec> {
        Extctlin3W::new(self, 3)
    }
    #[doc = "Bit 4 - EXTCTL inputs."]
    #[inline(always)]
    #[must_use]
    pub fn extctlin_4(&mut self) -> Extctlin4W<ExtctlinportSpec> {
        Extctlin4W::new(self, 4)
    }
    #[doc = "Bit 5 - EXTCTL inputs."]
    #[inline(always)]
    #[must_use]
    pub fn extctlin_5(&mut self) -> Extctlin5W<ExtctlinportSpec> {
        Extctlin5W::new(self, 5)
    }
    #[doc = "Bit 6 - EXTCTL inputs."]
    #[inline(always)]
    #[must_use]
    pub fn extctlin_6(&mut self) -> Extctlin6W<ExtctlinportSpec> {
        Extctlin6W::new(self, 6)
    }
    #[doc = "Bit 7 - EXTCTL inputs."]
    #[inline(always)]
    #[must_use]
    pub fn extctlin_7(&mut self) -> Extctlin7W<ExtctlinportSpec> {
