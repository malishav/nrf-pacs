...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn patw1(&mut self) -> Patw1W<SuppportedtestpatternmodesSpec> {
        Patw1W::new(self, 0)
    }
    #[doc = "Bit 1 - Indicates whether the walking 0s pattern is supported as output over the trace port."]
    #[inline(always)]
    #[must_use]
    pub fn patw0(&mut self) -> Patw0W<SuppportedtestpatternmodesSpec> {
        Patw0W::new(self, 1)
    }
    #[doc = "Bit 2 - Indicates whether the AA/55 pattern is supported as output over the trace port."]
    #[inline(always)]
    #[must_use]
    pub fn pata5(&mut self) -> Pata5W<SuppportedtestpatternmodesSpec> {
        Pata5W::new(self, 2)
    }
    #[doc = "Bit 3 - Indicates whether the FF/00 pattern is supported as output over the trace port."]
    #[inline(always)]
    #[must_use]
    pub fn patf0(&mut self) -> Patf0W<SuppportedtestpatternmodesSpec> {
        Patf0W::new(self, 3)
    }
    #[doc = "Bit 16 - Indicates whether timed mode is supported."]
    #[inline(always)]
    #[must_use]
    pub fn ptimeen(&mut self) -> PtimeenW<SuppportedtestpatternmodesSpec> {
        PtimeenW::new(self, 16)
    }
    #[doc = "Bit 17 - Indicates whether continuous mode is supported."]
    #[inline(always)]
    #[must_use]
    pub fn pconten(&mut self) -> PcontenW<SuppportedtestpatternmodesSpec> {
