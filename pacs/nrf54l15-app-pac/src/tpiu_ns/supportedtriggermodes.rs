...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mult_0(&mut self) -> Mult0W<SupportedtriggermodesSpec> {
        Mult0W::new(self, 0)
    }
    #[doc = "Bit 1 - Indicates whether multiplying the trigger counter by 2^(1+1) is supported."]
    #[inline(always)]
    #[must_use]
    pub fn mult_1(&mut self) -> Mult1W<SupportedtriggermodesSpec> {
        Mult1W::new(self, 1)
    }
    #[doc = "Bit 2 - Indicates whether multiplying the trigger counter by 2^(2+1) is supported."]
    #[inline(always)]
    #[must_use]
    pub fn mult_2(&mut self) -> Mult2W<SupportedtriggermodesSpec> {
        Mult2W::new(self, 2)
    }
    #[doc = "Bit 3 - Indicates whether multiplying the trigger counter by 2^(3+1) is supported."]
    #[inline(always)]
    #[must_use]
    pub fn mult_3(&mut self) -> Mult3W<SupportedtriggermodesSpec> {
        Mult3W::new(self, 3)
    }
    #[doc = "Bit 4 - Indicates whether multiplying the trigger counter by 2^(4+1) is supported."]
    #[inline(always)]
    #[must_use]
    pub fn mult_4(&mut self) -> Mult4W<SupportedtriggermodesSpec> {
        Mult4W::new(self, 4)
    }
    #[doc = "Bit 8 - Indicates whether an 8-bit wide counter register is implemented."]
    #[inline(always)]
    #[must_use]
    pub fn tcount8(&mut self) -> Tcount8W<SupportedtriggermodesSpec> {
        Tcount8W::new(self, 8)
    }
    #[doc = "Bit 16 - A trigger has occurred and the counter has reached 0."]
    #[inline(always)]
    #[must_use]
    pub fn triggered(&mut self) -> TriggeredW<SupportedtriggermodesSpec> {
        TriggeredW::new(self, 16)
    }
    #[doc = "Bit 17 - A trigger has occurred but the counter is not at 0."]
    #[inline(always)]
    #[must_use]
    pub fn trgrun(&mut self) -> TrgrunW<SupportedtriggermodesSpec> {
        TrgrunW::new(self, 17)
    }
}
