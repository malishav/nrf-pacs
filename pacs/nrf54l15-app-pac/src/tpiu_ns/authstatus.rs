...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn nsid(&mut self) -> NsidW<AuthstatusSpec> {
        NsidW::new(self, 0)
    }
    #[doc = "Bits 2:3 - Non-secure Non-Invasive Debug"]
    #[inline(always)]
    #[must_use]
    pub fn nsnid(&mut self) -> NsnidW<AuthstatusSpec> {
        NsnidW::new(self, 2)
    }
    #[doc = "Bits 4:5 - Secure Invasive Debug"]
    #[inline(always)]
    #[must_use]
    pub fn sid(&mut self) -> SidW<AuthstatusSpec> {
        SidW::new(self, 4)
    }
    #[doc = "Bits 6:7 - Secure Non-Invasive Debug"]
    #[inline(always)]
    #[must_use]
    pub fn snid(&mut self) -> SnidW<AuthstatusSpec> {
        SnidW::new(self, 6)
    }
}
