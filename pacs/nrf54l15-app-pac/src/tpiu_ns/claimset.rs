...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bit_0(&mut self) -> Bit0W<ClaimsetSpec> {
        Bit0W::new(self, 0)
    }
    #[doc = "Bit 1 - Set claim bit 1 and check if bit is implemented or not."]
    #[inline(always)]
    #[must_use]
    pub fn bit_1(&mut self) -> Bit1W<ClaimsetSpec> {
        Bit1W::new(self, 1)
    }
    #[doc = "Bit 2 - Set claim bit 2 and check if bit is implemented or not."]
    #[inline(always)]
    #[must_use]
    pub fn bit_2(&mut self) -> Bit2W<ClaimsetSpec> {
        Bit2W::new(self, 2)
    }
    #[doc = "Bit 3 - Set claim bit 3 and check if bit is implemented or not."]
    #[inline(always)]
    #[must_use]
    pub fn bit_3(&mut self) -> Bit3W<ClaimsetSpec> {
        Bit3W::new(self, 3)
    }
}
