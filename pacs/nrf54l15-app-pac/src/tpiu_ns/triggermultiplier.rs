...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mult_0(&mut self) -> Mult0W<TriggermultiplierSpec> {
        Mult0W::new(self, 0)
    }
    #[doc = "Bit 1 - Multiply the Trigger Counter by 2^n."]
    #[inline(always)]
    #[must_use]
    pub fn mult_1(&mut self) -> Mult1W<TriggermultiplierSpec> {
        Mult1W::new(self, 1)
    }
    #[doc = "Bit 2 - Multiply the Trigger Counter by 2^n."]
    #[inline(always)]
    #[must_use]
    pub fn mult_2(&mut self) -> Mult2W<TriggermultiplierSpec> {
        Mult2W::new(self, 2)
    }
    #[doc = "Bit 3 - Multiply the Trigger Counter by 2^n."]
    #[inline(always)]
    #[must_use]
    pub fn mult_3(&mut self) -> Mult3W<TriggermultiplierSpec> {
        Mult3W::new(self, 3)
    }
    #[doc = "Bit 4 - Multiply the Trigger Counter by 2^n."]
    #[inline(always)]
    #[must_use]
    pub fn mult_4(&mut self) -> Mult4W<TriggermultiplierSpec> {
        Mult4W::new(self, 4)
    }
}
