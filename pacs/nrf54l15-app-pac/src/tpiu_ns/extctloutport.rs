...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn extctlout_0(&mut self) -> Extctlout0W<ExtctloutportSpec> {
        Extctlout0W::new(self, 0)
    }
    #[doc = "Bit 1 - EXTCTL outputs."]
    #[inline(always)]
    #[must_use]
    pub fn extctlout_1(&mut self) -> Extctlout1W<ExtctloutportSpec> {
        Extctlout1W::new(self, 1)
    }
    #[doc = "Bit 2 - EXTCTL outputs."]
    #[inline(always)]
    #[must_use]
    pub fn extctlout_2(&mut self) -> Extctlout2W<ExtctloutportSpec> {
        Extctlout2W::new(self, 2)
    }
    #[doc = "Bit 3 - EXTCTL outputs."]
    #[inline(always)]
    #[must_use]
    pub fn extctlout_3(&mut self) -> Extctlout3W<ExtctloutportSpec> {
        Extctlout3W::new(self, 3)
    }
    #[doc = "Bit 4 - EXTCTL outputs."]
    #[inline(always)]
    #[must_use]
    pub fn extctlout_4(&mut self) -> Extctlout4W<ExtctloutportSpec> {
        Extctlout4W::new(self, 4)
    }
    #[doc = "Bit 5 - EXTCTL outputs."]
    #[inline(always)]
    #[must_use]
    pub fn extctlout_5(&mut self) -> Extctlout5W<ExtctloutportSpec> {
        Extctlout5W::new(self, 5)
    }
    #[doc = "Bit 6 - EXTCTL outputs."]
    #[inline(always)]
    #[must_use]
    pub fn extctlout_6(&mut self) -> Extctlout6W<ExtctloutportSpec> {
        Extctlout6W::new(self, 6)
    }
    #[doc = "Bit 7 - EXTCTL outputs."]
    #[inline(always)]
    #[must_use]
    pub fn extctlout_7(&mut self) -> Extctlout7W<ExtctloutportSpec> {
